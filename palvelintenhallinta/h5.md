...
Tästä eteenpäin oletan, että homma menee kuten shell skriptillä eli kopioin /usr/local/bin hakemistoon ja säädätn kaikille suoritusoikeudet ja kokeilen ajaa.
...
Testataan 
<pre><font color="#55FF55"><b>sanna@sanna-virtualbox</b></font>:<font color="#5555FF"><b>/usr/local/bin</b></font>$ heippapython.py 
Tervetuloa Python-maailmaan Sanna
</pre>
